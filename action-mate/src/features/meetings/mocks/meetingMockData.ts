...
export const MOCK_MEETINGS_SEED: MeetingPost[] = [
  ...
  // =========================
  // ✅ 상태 점검용 확장 데이터
  // - 목적: 실서비스에서 나올 수 있는 상태(OPEN/FULL/ENDED/CANCELED/STARTED)
  //         + 내 상태(HOST/MEMBER/PENDING/NONE)
  //         + 참여 불가(canJoin=false) 케이스를 카테고리별로 미리 점검
  // =========================
  ...
  // ---------- SPORTS ----------
  {
    ...
    conditions: "경력 1년 이상",
    meetingTime: h(5),
    location: { name: "잠실 종합운동장 코트", lat: 37.5159, lng: 127.0727 },
    distanceText: "3.2km",
    capacity: { current: 4, total: 6 },
    joinMode: "INSTANT",
    status: "OPEN",
  ...
  },
  {
    ...
    meetingTime: h(-0.7),
    location: { name: "반포한강공원", lat: 37.5094, lng: 126.9948 },
    distanceText: "2.0km",
    capacity: { current: 5, total: 6 },
    joinMode: "INSTANT",
    status: "STARTED",
    myState: { membershipStatus: "MEMBER", canJoin: false },
    durationMinutes: 120,
  ...
  },
  {
    ...
    meetingTime: h(7),
    location: { name: "서초구민체육센터", lat: 37.483, lng: 127.013 },
    distanceText: "1.4km",
    capacity: { current: 2, total: 6 },
    joinMode: "APPROVAL",
    status: "CANCELED",
  ...
  },
  {
    ...
    meetingTime: h(1.5),
    location: { name: "잠원체육관", lat: 37.5189, lng: 127.0111 },
    distanceText: "0.9km",
    capacity: { current: 4, total: 4 },
    joinMode: "INSTANT",
    status: "FULL",
  ...
  // ---------- MEAL ----------
  {
    ...
    location: { name: "청담 오마카세", lat: 37.5255, lng: 127.0476 },
    distanceText: "2.7km",
    capacity: { current: 1, total: 3 },
    joinMode: "APPROVAL",
    status: "OPEN",
    myState: { membershipStatus: "PENDING", canJoin: false, reason: "승인 대기중" },
    durationMinutes: 120,
  ...
  },
  {
    ...
    meetingTime: h(2.5),
    location: { name: "역삼 치킨집", lat: 37.5009, lng: 127.0366 },
    distanceText: "1.0km",
    capacity: { current: 6, total: 6 },
    joinMode: "INSTANT",
    status: "FULL",
  ...
  },
  {
    ...
    meetingTime: h(4),
    location: { name: "서초 샐러드 카페", lat: 37.4919, lng: 127.0078 },
    distanceText: "0.9km",
    capacity: { current: 3, total: 4 },
    joinMode: "APPROVAL",
    status: "CANCELED",
  ...
  },
  {
    ...
    meetingTime: h(-0.3),
    location: { name: "강남 국밥집", lat: 37.4987, lng: 127.0281 },
    distanceText: "0.4km",
    capacity: { current: 4, total: 4 },
    joinMode: "INSTANT",
    status: "STARTED",
  ...
  // ---------- STUDY ----------
  {
    ...
    location: { name: "서초 도서관", lat: 37.489, lng: 127.014 },
    distanceText: "1.6km",
    capacity: { current: 2, total: 6 },
    joinMode: "APPROVAL",
    status: "OPEN",
  ...
  },
  {
    ...
    meetingTime: h(-1.2),
    location: { name: "역삼 공유오피스", lat: 37.5002, lng: 127.0362 },
    distanceText: "1.2km",
    capacity: { current: 5, total: 6 },
    joinMode: "APPROVAL",
    status: "STARTED",
  ...
  },
  {
    ...
    location: { name: "선릉 스터디룸", lat: 37.5045, lng: 127.0488 },
    distanceText: "2.1km",
    capacity: { current: 3, total: 5 },
    joinMode: "APPROVAL",
    status: "CANCELED",
    myState: { membershipStatus: "HOST", canJoin: false, reason: "호스트" },
    durationMinutes: 120,
  ...
  },
  {
    ...
    meetingTime: d(3, 9, 0),
    location: { name: "강남 스터디카페", lat: 37.4978, lng: 127.0275 },
    distanceText: "0.7km",
    capacity: { current: 6, total: 6 },
    joinMode: "APPROVAL",
    status: "FULL",
  ...
  // ---------- GAMES ----------
  {
    ...
    location: { name: "합정 보드게임 카페", lat: 37.5497, lng: 126.9141 },
    distanceText: "1.9km",
    capacity: { current: 2, total: 4 },
    joinMode: "APPROVAL",
    status: "OPEN",
  ...
  },
  {
    ...
    meetingTime: h(-0.5),
    location: { name: "홍대 게임 카페", lat: 37.5562, lng: 126.9229 },
    distanceText: "1.3km",
    capacity: { current: 4, total: 4 },
    joinMode: "INSTANT",
    status: "STARTED",
  ...
  },
  {
    ...
    location: { name: "강남 방탈출", lat: 37.4984, lng: 127.0278 },
    distanceText: "0.5km",
    capacity: { current: 2, total: 6 },
    joinMode: "APPROVAL",
    status: "CANCELED",
  ...
  },
  {
    ...
    location: { name: "건대 보드게임 카페", lat: 37.5404, lng: 127.0705 },
    distanceText: "3.0km",
    capacity: { current: 6, total: 6 },
    joinMode: "APPROVAL",
    status: "ENDED",
